...
class _SavingsGoalWidgetState extends State<SavingsGoalWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SavingsGoalModel());
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Enter the details below to set a savings goal for your kids. Encourage them to save and they could be the winners when they achieve their goal!',
